...
class OrderControllerTest {
    ...
    void init() {
        ...
        Mockito.when(cartServiceIntegration.getCart("bobsdgdgdfgdsharjre433523253g435")).thenReturn(cartDTO);
        OrderInfo orderInfo = new OrderInfo();
//        orderInfo.setUsername("bobsdgdgdfgdsharjre433523253g435");
        orderInfo.setAddress("adsad");
        orderInfo.setPhone("89513");
        webTestClient.post().uri("/api/v1/order/create").body(BodyInserters.fromValue(orderInfo)).header("username", "bobsdgdgdfgdsharjre433523253g435")
    ...
    void checkOrders() {
        ...
        List<OrderDTOShort> savedDTOShort = webTestClient.get()
                .uri("/api/v1/order/checkAll").header("username", "bobsdgdgdfgdsharjre433523253g435")
        ...
        Assertions.assertEquals(BigDecimal.valueOf(3500.0), savedDTOShort.get(0).getTotalPrice());
    ...
    void checkOrderInfo() {
        ...
        OrderDTOFullInfo savedDTOFull = webTestClient.post()
                ...
                .header("username", "bobsdgdgdfgdsharjre433523253g435")
